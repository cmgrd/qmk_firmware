...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {                                                   
        ...
        //,--------------------------------------------------------------                ------------------------------------------------------.
            HYPR_T(KC_TAB),   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                     KC_Y,    KC_U,    KC_I,    KC_O,   KC_P,  RGUI_T(KC_APP),
        //|----------------+--------+--------+--------+--------+--------+                +--------+--------+--------+--------+--------+--------|
    LSFT_T(KC_ESC), RGUI_T(KC_A),ALT_T(KC_S),CTL_T(KC_D), KC_F, KC_G,                     KC_H,    KC_J, CTL_T(KC_K),ALT_T(KC_L), RGUI_T(KC_SCLN), LALT_T(KC_DOUBLE_QUOTE),
        //|----------------+--------+--------+--------+--------+--------+                +--------+--------+--------+--------+--------+--------|
        ...
        //,------------------------------------------------------                    ------------------------------------------------------.
            _______, KC_BRIU, _______, _______, _______, KC_VOLU,                      _______,   KC_P7,   KC_P8,   KC_P9,KC_MINUS, _______,
        //|--------+--------+--------+--------+--------+--------+                    +--------+--------+--------+--------+--------+--------|
            _______, KC_BRID, KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLD,                      _______,   KC_P4,   KC_P5,   KC_P6, KC_PLUS, _______, 
        //|--------+--------+--------+--------+--------+--------+                    +--------+--------+--------+--------+--------+--------|
            _______, _______, _______, _______, _______, KC_MUTE,                      _______,   KC_P1,   KC_P2,   KC_P3,  KC_ENT, _______, 
        //|--------+--------+--------+--------+--------+--------+                    +--------+--------+--------+--------+--------+--------|
                                                _______, _______, _______,    _______,   KC_P0,   TO(0)
                                            //`--------------------------'  `--------------------------'
        ),
