...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {                                                   
        ...
        //|----------------+--------+--------+--------+--------+--------+                +--------+--------+--------+--------+--------+--------|
      CTL_T(KC_ESC), ALT_T(KC_A),CTL_T(KC_S),RGUI_T(KC_D), KC_F, KC_G,                     KC_H,    KC_J, RGUI_T(KC_K),CTL_T(KC_L), ALT_T(KC_SCLN), HYPR_T(KC_DOUBLE_QUOTE),
        //|----------------+--------+--------+--------+--------+--------+                +--------+--------+--------+--------+--------+--------|
        ...
        //,------------------------------------------------------                    ------------------------------------------------------.
            LIT_GRV,   KC_AT, KC_HASH, KC_PERC, KC_AMPR, KC_PIPE,                      KC_ASTR, KC_CIRC, KC_EXLM, KC_DLR, KC_PLUS, CW_TOGG, 
        //|--------+--------+--------+--------+--------+--------+                    +--------+--------+--------+--------+--------+--------|
        ...
        //,------------------------------------------------------                    ------------------------------------------------------.
            _______, KC_BRIU, _______, _______, _______, KC_VOLU,                      KC_PSLS,   KC_P7,   KC_P8,   KC_P9,KC_MINUS, _______,
        //|--------+--------+--------+--------+--------+--------+                    +--------+--------+--------+--------+--------+--------|
            _______, KC_BRID, KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLD,                      KC_PAST,   KC_P4,   KC_P5,   KC_P6, KC_PLUS, _______, 
        //|--------+--------+--------+--------+--------+--------+                    +--------+--------+--------+--------+--------+--------|
            _______, _______, _______, _______, _______, KC_MUTE,                      KC_PCMM,   KC_P1,   KC_P2,   KC_P3,  KC_ENT, _______, 
        //|--------+--------+--------+--------+--------+--------+                    +--------+--------+--------+--------+--------+--------|
