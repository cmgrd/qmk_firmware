...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   LSFT_T(KC_ESC), RGUI_T(KC_A),ALT_T(KC_S),CTL_T(KC_D), KC_F, KC_G, KC_NO,      KC_NO,    KC_H,     KC_J,CTL_T(KC_K),ALT_T(KC_L), RGUI_T(KC_SCLN), LALT_T(KC_DOUBLE_QUOTE),
    ...
    //,--------------------------------------------------------------.  ,--------------------------------------------------------------.
         KC_GRV,   KC_AT, KC_HASH, KC_PERC, KC_AMPR, KC_PIPE,   KC_NO,      KC_NO, KC_ASTR, KC_CIRC, KC_EXLM, KC_DLR, KC_PLUS, CW_TOGG, 
    //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
    ...
    //,--------------------------------------------------------------.  ,--------------------------------------------------------------.
        _______, KC_BRIU, _______, _______, _______, KC_VOLU, _______,    _______, _______,   KC_P7,   KC_P8,   KC_P9,KC_MINUS, _______,
    //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
        _______, KC_BRID, KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLD, KC_MUTE,    _______, _______,   KC_P4,   KC_P5,   KC_P6, KC_PLUS, _______, 
    //|--------+--------+--------+--------+--------+--------+--------'  `--------+--------+--------+--------+--------+--------+--------|
